...
async def run_sample(client):
    from src.yolodetect import detect
    # Customize this coroutine to do whatever tasks the module initiates
    # e.g. sending messages
    while True:
        # calling generator that yields a list with info about detected objects
        for list_obj_info in detect(vid_path='https://nvidia.box.com/shared/static/veuuimq6pwvd62p9fresqhrrmfqz0e2f.mp4',
                                    show_image=False,
                                    show_box=False,
                                    show_tracks=False,
        ...
        #await client.send_message(str(results))
